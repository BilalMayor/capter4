           ...
           <header className="flex justify-between items-center p-4 mb-0 bg-primary shadow-md">
               ...
               <div className="relative">
                   ...
                   <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-10 top-full">
                       <a href="#" className="block px-4 py-2 text-sm text-black hover:bg-gray-100">Profile</a>
                       <a href="#" className="block px-4 py-2 text-sm text-black hover:bg-gray-100">Settings</a>
...
{/* content section */}
      ...
      {/* sidebar section */}
      <div className={`flex flex-col w-2/3 md:w-1/2 lg:w-1/4 h-full fixed 
          ...
          <div className="px-5 text-gray-500">
            {menuList.map((menu, index) => (
              <MenuItem icon={menu.icon} label={menu.label} 
                path={menu.path} active={menu.id === id} 
                key={`keyMenu${index}`} />
            ))}
          </div>
        </div>
